...
class CommentServiceTest {
    ...
    void deleteShouldMarkDeletedIfHasChildren() {
        ...
        given(commentRepository.countBy(articleId, commentId, 2)).willReturn(2L);
    ...
    void deleteShouldDeleteChildOnlyIfNotDeletedParent() {
        ...
        given(commentRepository.findById(commentId))
                .willReturn(Optional.of(comment));
        given(commentRepository.countBy(articleId, commentId, 2)).willReturn(1L);
    ...
    void deleteShouldDeleteAllRecursivelyIfDeletedParent() {
        ...
        given(commentRepository.findById(parentCommentId))
                .willReturn(Optional.of(parentComment));
        given(commentRepository.countBy(articleId, parentCommentId, 2)).willReturn(1L);
    ...
    private Comment createComment(Long articleId, Long commentId) {
        ...
        given(comment.getPostId()).willReturn(articleId);
